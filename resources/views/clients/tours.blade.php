            ...
            <div class="col-lg-9">
                <div class="shop-shorter rel z-3 mb-20">
                    ...
                    <select>
                        ...
                        <option value="hight-to-low">Giá cao nhất</option>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="destination-item tour-grid style-three bgc-lighter" data-aos="fade-up"
                                ...
                                <div class="content">
                                    ...
                                    <h6><a href="{{ route('tour-detail') }}">Biển Sầm Sơn, Thanh Hóa, Việt Nam</a>
                                    </h6>
                                    <ul class="blog-meta">
                                        <li><i class="far fa-clock"></i> 3 ngày 2 đêm</li>
                                        <li><i class="far fa-user"></i> 5-8 hành khách</li>
                                    </ul>
                                    <div class="destination-footer">
                                        <span class="price"><span>$74.00</span>/person</span>
