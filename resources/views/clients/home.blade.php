        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <h2>Khám phá Việt Nam cùng Travela</h2>
                    <p>Một nơi <span class="count-text plus" data-speed="3000" data-stop="34500">0</span> những trải
                        nghiệm đáng nhớ!</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title mb-25">
                        <h2>Chọn chúng tôi – Trải nghiệm du lịch an tâm</h2>
                    </div>
                    <p>Chúng tôi biến giấc mơ du lịch của bạn thành hiện thực – Khám phá những viên ngọc ẩn và điểm đến
                        không thể bỏ lỡ!
                    </p>
                ...
                <div class="row pb-25">
                    <div class="col-md-6">
                        <div class="feature-item">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('tours') }}">Lều cắm trại</a></h5>
                                <p>Cách tuyệt vời để kết nối với thiên nhiên</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                ...
                                <p>Hoạt động ngoài trời thú vị mang tính phiêu lưu</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-item mt-20">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="{{ route('tours') }}">Đạp xe leo núi</a></h5>
                                <p>Môn thể thao thú vị giúp rèn luyện thể lực</p>
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="{{ route('tours') }}">Đi thuyền câu cá</a></h5>
                                <p>Niềm vui tao nhã với việc câu cá ngoài trời</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                <div class="cta-item"
                    ...
                    <span class="category">Lều cắm trại</span>
            ...
            <div class="col-lg-12">
                <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <p>Website <span class="count-text plus bgc-primary" data-speed="3000"
                            data-stop="34500">0</span> trải nghiệm nổi tiếng đáng nhớ</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-xl-4 col-md-6">
                <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="content">
                        ...
                        <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation with Travela
                                Travel Agency</a></h5>
                        <ul class="blog-meta">
