            ...
            <div class="col-xl-5 col-lg-6">
                <div class="mobile-app-content rmb-55" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="section-title counter-text-wrap mb-40">
                        <h2>Sổ tay tuyệt vời của người khám phá</h2>
                    </div>
                    <p>Chúng tôi làm việc chặt chẽ với khách hàng để hiểu thách thức và mục tiêu, cung cấp giải pháp
                        tùy chỉnh để nâng cao hiệu suất, tăng lợi nhuận và thúc đẩy sự tăng trưởng bền vững.</p>
                    ...
                    <ul class="list-style-two mt-35 mb-30">
                        <li>Công ty dịch vụ kinh nghiệm</li>
                        <li>Đội ngũ chuyên nghiệp</li>
                    </ul>
                    <a href="{{ route('about') }}" class="theme-btn style-two">
                        <span data-hover="Khám phá hướng dẫn viên">Khám phá hướng dẫn viên</span>
