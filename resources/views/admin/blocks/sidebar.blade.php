            ...
            <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle"
                        ...
                        aria-expanded="false">
                        <img src="{{ asset('admin/assets/images/user-profile/unnamed.png') }}" alt="">Admin
                    </a>
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu"
                        ...
                        <li class="nav-item">
                            <a class="dropdown-item">
                                <span class="image"><img src="src="{{ asset('admin/assets/images/user-profile/unnamed.png') }}""
                        ...
                        <li class="nav-item">
                            <a class="dropdown-item">
                                <span class="image"><img src="{{ asset('admin/assets/images/user-profile/unnamed.png') }}""
                                        alt="Profile Image" /></span>
                                <span>
                                    <span>John Smith</span>
                                    <span class="time">3 mins ago</span>
