                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> KM10 Nguyễn Trãi, Hà Đông, Hà Nội</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:dtn752k4@gmail.com">dtn752k4@gmail.com</a></li>
                            <li><i class="fal fa-phone-volume"></i> <a href="callto:+84987654321">+84 (987)
                                    654 321</a></li>
                        </ul>
                    </div>
                </div>
